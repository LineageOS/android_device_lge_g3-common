        ...
        void *user)
{
    ...
    sNotifCb = notify_cb;
    VENDOR_CALL(device, set_callbacks, notify_intercept, data_cb,
...
static int camera_start_recording(struct camera_device *device)
{
    ...
    parameters2.unflatten(String8(
            VENDOR_CALL(device, get_parameters)));
    parameters2.dump();
                                 ...
                                 const char *parameters)
{
    ...
    char *tmpParameters = strdup(parameters);

    CameraParameters2 params;
    params.unflatten(String8(tmpParameters));
    ...
    if (CAMERA_ID(device) == REAR_CAMERA_ID) {
        params.set(CameraParameters::KEY_LGE_CAMERA,
                is4k(params) ? "1" : "0");

        if (!strncmp(params.get(
                CameraParameters::KEY_SCENE_MODE), "hdr", 3)) {
    ...
    if (params.get(CameraParameters::KEY_ISO_MODE)) {
        isoMode = params.get(CameraParameters::KEY_ISO_MODE);
        ALOGV("%s: ISO mode: %s", __FUNCTION__, isoMode);

        if (strcmp(isoMode, "auto") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "auto");
        } else if (strcmp(isoMode, "ISO50") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "50");
        } else if (strcmp(isoMode, "ISO100") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "100");
        } else if (strcmp(isoMode, "ISO150") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "150");
        } else if (strcmp(isoMode, "ISO200") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "200");
        } else if (strcmp(isoMode, "ISO250") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "250");
        } else if (strcmp(isoMode, "ISO300") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "300");
        } else if (strcmp(isoMode, "ISO350") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "350");
        } else if (strcmp(isoMode, "ISO400") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "400");
        } else if (strcmp(isoMode, "ISO450") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "450");
        } else if (strcmp(isoMode, "ISO500") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "500");
        } else if (strcmp(isoMode, "ISO600") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "600");
        } else if (strcmp(isoMode, "ISO700") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "700");
        } else if (strcmp(isoMode, "ISO800") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "800");
        } else if (strcmp(isoMode, "ISO1000") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "1000");
        } else if (strcmp(isoMode, "ISO1500") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "1500");
        } else if (strcmp(isoMode, "ISO2000") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "2000");
        } else if (strcmp(isoMode, "ISO2700") == 0) {
            params.set(CameraParameters::KEY_LGE_ISO_MODE, "2700");
        } else {
...
static char *camera_get_parameters(struct camera_device *device)
{
    ...
    if (CAMERA_ID(device) == REAR_CAMERA_ID) {
        params.set(CameraParameters::KEY_SUPPORTED_VIDEO_SIZES,
            "3840x2160,1920x1080,1440x1080,1280x720,864x480,848x480,800x480,720x480,640x480,480x320,352x288,320x240,176x144,160x120,144x176");
        params.set(CameraParameters::KEY_SUPPORTED_ISO_MODES, 
            "auto,ISO50,ISO100,ISO150,ISO200,ISO250,ISO300,ISO350,ISO400,ISO450,ISO500,ISO600,ISO700,ISO800,ISO1000,ISO1500,ISO2000,ISO2700,auto");
        ...
        params.set(CameraParameters::KEY_SUPPORTED_ISO_MODES, "auto");
    }

    /* lge-iso to iso */
    if (params.get(CameraParameters::KEY_LGE_ISO_MODE)) {
        isoMode = params.get(CameraParameters::KEY_LGE_ISO_MODE);
        ALOGV("%s: ISO mode: %s", __FUNCTION__, isoMode);

        if (strcmp(isoMode, "auto") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "auto");
        } else if (strcmp(isoMode, "50") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO50");
        } else if (strcmp(isoMode, "100") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO100");
        } else if (strcmp(isoMode, "150") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO150");
        } else if (strcmp(isoMode, "200") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO200");
        } else if (strcmp(isoMode, "250") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO250");
        } else if (strcmp(isoMode, "300") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO300");
        } else if (strcmp(isoMode, "350") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO350");
        } else if (strcmp(isoMode, "400") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO400");
        } else if (strcmp(isoMode, "450") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO450");
        } else if (strcmp(isoMode, "500") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO500");
        } else if (strcmp(isoMode, "600") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO600");
        } else if (strcmp(isoMode, "700") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO700");
        } else if (strcmp(isoMode, "800") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO800");
        } else if (strcmp(isoMode, "1000") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO1000");
        } else if (strcmp(isoMode, "1500") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO1500");
        } else if (strcmp(isoMode, "2000") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO2000");
        } else if (strcmp(isoMode, "2700") == 0) {
            params.set(CameraParameters::KEY_ISO_MODE, "ISO2700");
        }
    }
